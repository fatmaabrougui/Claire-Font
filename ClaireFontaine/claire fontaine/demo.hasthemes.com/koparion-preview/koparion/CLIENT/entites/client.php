...
class client{
	...
	private $pwd_client;
	private $tel_client;
	private $categorie_client;
	function __construct($id_client,$nom_client,$prenom_client,$email_client,$pwd_client,$tel_client,$categorie_client){
	...
	function setcategorieclient($categorie_client){
