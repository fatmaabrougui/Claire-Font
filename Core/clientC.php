...
function afficherClient ($client){
		...
		echo "nom_categorie: ".$client->getcategorieclient()."<br>";
	}
	function ajouterClient($client){
		$sql="insert into client (id_client,nom_client,prenom_client,email_client,pwd_client,tel_client,nom_categorie) values (:id_client,:nom_client,:prenom_client,:email_client,:pwd_client,:tel_client,:nom_categorie)";
		...
		$nom_categorie=$client->getcategorieclient();
	...
	function modifierClient($client,$id_client){
		$sql="UPDATE client SET id_client=:id_clientn,nom_client=:nom_client,prenom_client=:prenom_client,email_client=:email_client,pwd_client=:pwd_client,tel_client=:tel_client,nom_categorie=:nom_categorie WHERE id_client=:id_client";
...
try{		
		...
		$tel_client=$client->gettelclient();
		$nom_categorie=$client->getcategorieclient();
		$datas = array(':id_clientn'=>$id_clientn,':id_client'=>$id_client,':nom_client'=>$nom_client,':prenom_client'=>$prenom_client,':email_client'=>$email_client,':pwd_client'=>$pwd_client,':tel_client'=>$tel_client,':nom_categorie'=>$nom_categorie);
  ...
  print_r($datas);
	...
	function rechercherListeClients($nom_categorie){
		$sql="SELECT * from client where nom_categorie=$nom_categorie";
		$db = config::getConnexion();
		try{
		$liste=$db->query($sql);
		return $liste;
