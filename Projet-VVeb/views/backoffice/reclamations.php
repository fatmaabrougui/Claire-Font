                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <table id="mytable" class="table table-bordred table-striped">
                                ...
                                <tbody>
                                <?php include "../../core/reclamation.php";
                                $R=new reclamation();
                                if(isset($_GET['page'])) {
                                    $page=$_GET['page'];
                                } else {
                                ...
                                $result =$R->afficher($page_1);

                                $count=ceil(($R->count())/6);
...

                                {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form method="POST" action="../../core/modifier.php" >
                                                <input hidden name="email" value="<?php echo $row["user"]?>">
                                                <input hidden name="IDSUP" value="<?php echo $row["Id_reclamation"]?>">
                                                <?php if( $row["etat"]=="traité") {?>
                                      ...
                                      <?php } else {  ?>
                                        ...
                                        <form method="POST" action="../../core/supprimer.php" >
                        ...
                        <div>
                            <ul class="pagination">
                                ...
                                if($count>1)
                                {
                                    for($i=1;$i<=$count;$i++) {
                                        if($i==$page)
                                        { echo "<li> <a style='   background: grey ; width: 10px' href='reclamations.php?page={$i}'>{$i}</a> </li>  " ; }
                                        else {  echo "<li> <a href='reclamations.php?page={$i}'>{$i}</a> </li>  " ;}
