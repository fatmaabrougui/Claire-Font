    ...
    <div class="banner-area banner-res-large pt-30 pb-5">
        <div class="container">
            <div class="row" style="height: 1050px">
                <!--  Product Details -->
                <div id="form-main">
                    <h1 style="position: relative ; right: -300px" > Formulaire De Reclamation</h1>
                    <br>
                    <div id="form-div">

                        <form method="post" action="../core/ajouterreclamation.php" enctype="multipart/form-data" style="
    margin-left:auto;
    margin-right:auto;
    width: 423px;
    position: relative;
...
">
                            ...
                            <ul>
                                <li>
                                    <input style=" width: 20px; height: 20px" type="radio" checked  id="one" name="type" value="probleme d'achat en ligne"   />
                                    <label for="one" >problème d'achat en ligne</label>

                                    <div class="check"></div>
                                </li>
                                <li>
                                    <input style=" width: 20px; height: 20px"  type="radio"  id="two" name="type" value="Probleme boutique" />
                                    <label for="two" >Probleme boutique</label>
                            ...
                            <div>
                                ...
                                <img id="blah" src="#" alt="" style=" border-radius: 25px;"/>
                                <br>
                                <br>

                                <div>  <a style="overflow: hidden;" href="" data-toggle="modal" data-target="#exampleModal" ><h4>conditions d'utilisation </h4>  </a>  <input  style="position: relative; right: -290px;top: -32px ; width: 20px; height: 20px" type="checkbox"  required id="cbtest" /> </div>

                                <br>
                            </div>
                            <div class="submit">
                                <input name="button-blue" style=" background: orangered ; color: white ; position: relative; right: -50px"  type="submit" value="Envoyer" />
                                <div class="ease"></div>
                            </div>
                        </form>
                    </div>
