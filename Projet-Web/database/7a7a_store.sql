...
id`,
`name
`, `email`, `password`, `is_active`) VALUES
(1, 'admin 1', 'admin1@gmail.com', '$2y$10$luIW4fiqSZ5NuIwk.gxJ8eGb7EA/JMP6VrbeU0HKk.ljqCKVZanqu', '0'),
(2, 'admin 2', 'admin2@gmail.com', '$2y$10$YswvwR1nWSEe7PIzNjNl..uGRmqx4ELxUhsK8tlLCdNVXXhJ1KSKK', '0');
...
INSERT INTO `orders` (`
order_id`,`user_id`, `product_id`, `qty`, `trx_id`, `p_status`) VALUES
...
product_id`,
`product_cat
`, `product_brand`, `product_title`, `product_price`, `product_qty`, `product_desc`, `product_image`, `product_keywords`) VALUES
...
ADD PRIMARY KEY
(`product_id`),
ADD KEY `fk_product_cat`
(`product_cat`),
ADD KEY `fk_product_brand`
(`product_brand`);
...
ALTER TABLE `categories`
  MODIFY `cat_id` int
(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
ALTER TABLE `user_info`
  MODIFY `user_id` int
(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `products`
ADD CONSTRAINT `fk_product_brand` FOREIGN KEY
(`product_brand`) REFERENCES `brands`
(`brand_id`),
ADD CONSTRAINT `fk_product_cat` FOREIGN KEY
(`product_cat`) REFERENCES `categories`
(`cat_id`);
COMMIT;
