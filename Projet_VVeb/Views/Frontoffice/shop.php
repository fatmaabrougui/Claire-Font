...
<!-- Mirrored from demo.hasthemes.com/koparion-preview/koparion/shop.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 20 Nov 2019 17:48:07 GMT -->
<head>
	<meta charset="utf-8">
...
$query=$bdd->prepare("SELECT * from produit left join promotion on produit.id_produit=promotion.id_produit ");
$query->execute(); 
										...
										<div class="product-img">
											...
											<div class="product-flag">
												<ul>
													...
													<li><span class="sale"><?php
$annee = date('Y');
$duree = mktime(0,0,0,$r->datem,$r->datej, $annee);

if ($duree < time())
$duree = mktime(0,0,0,$r->datem,$r->datej, ++$annee);

$tps_restant = $duree - time(); //
...
$i_restantes = floor($i_restantes % 60); // Minutes près
$H_restantes = floor($H_restantes % 24); // Heures près
$d_restants = floor($d_restants); // Jour près
//==================

setlocale(LC_ALL, 'fr_FR');

echo  ' <strong>'. $d_restants .' days</strong>, <strong>'. $H_restantes .' hours</strong></br>,'
. ' <strong>'. $i_restantes .' minutes</strong>';    ?></span></li>
													<li><span class="discount-percentage"><?php echo "-", $r->pourcentage."%" ?></span></li>
										...
										<div class="product-details text-center">
											...
											<h4><a href="#"><?php echo $r->titre; ?></a></h4>
											<div class="product-price">
												<ul>
													<li>$<?php echo $r->prix-($r->prix*$r->pourcentage*0.01); ?></li>
													<li class="old-price">$<?php echo $r->prix; ?></li>
												</ul>
											</div>
										</div>
...
<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
									...
									<div class="product-wrapper mb-40">
										<div class="product-img">
											...
											<div class="product-flag">
												<ul>
													<li><span class="sale">no promotion</span></li>
												</ul>
											</div>
										</div>
										<div class="product-details text-center">
...
<!-- Mirrored from demo.hasthemes.com/koparion-preview/koparion/shop.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 20 Nov 2019 17:48:08 GMT -->
</html>