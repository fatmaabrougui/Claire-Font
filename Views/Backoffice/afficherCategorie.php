                                    ...
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        foreach($listeCategorie as $row){
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="supprimerCategorie.php?id_categorie=<?PHP echo $row['id_categorie']; ?>"> Supprimer</a>
                                                </td>
                                                <td><a href="modifierCategorie.php?id_categorie=<?PHP echo $row['id_categorie']; ?>">  Modifier</a></td>
                                            </tr>
                          <?php
                                        }
                          ?>
