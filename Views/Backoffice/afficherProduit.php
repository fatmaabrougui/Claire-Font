                                    ...
                                    <table class="table table-borderless table-striped table-earning">
                                        <thead>
                                            <tr>
                                              <th class="text-right">Image</th>
                                                ...
                                                <th class="text-right">option1</th>
                                                <th class="text-right">option2</th>
                                        ...
                                        foreach($listeProduits as $row){
                                            ...
                                            <tr>
                                                  ...
                                                  <td><img width="70px" height="70px" src="<?PHP echo '../uploads/'.$row['image']; ?>"></td>
                                                ...
                                                <td><a href="supprimerProduit.php?id_produit=<?PHP echo $row['id_produit']; ?>"> Supprimer</a>
                                                </td>
                                                <td><a href="modifierProduit.php?id_produit=<?PHP echo $row['id_produit']; ?>">  Modifier</a></td>
                                            </tr>
<?php
                                        }?>
                                    </table>
