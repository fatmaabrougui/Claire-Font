...
if (!empty($_FILES['img'])) {
    ...
    $produit=new produit($_POST['id_produit'],$_POST['titre'],$_POST['categorie'],$_POST['description'],$_POST['prix'],$extension_upload,$_POST['stock']);
            ...
            <form class="forms-sample" id="addProduit" method="post"  enctype="multipart/form-data">
              <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" required class="form-control" name="prix" id="prix" placeholder="prix">
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail3">Stock</label>
                    <input type="number" required class="form-control" name="stock" id="stock" placeholder="stock">
                </div>
                ...
                <!--
                <div class="form-group">
                    <label for="exampleTextarea1">categorie</label>
                    <textarea required class="form-control" name="categorie" id="categorie" rows="4"></textarea>
                </div>
-->
