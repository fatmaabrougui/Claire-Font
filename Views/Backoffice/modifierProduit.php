...
if (isset($_GET['modifier'])){
  ...
  $produit=new produit($_POST['id_produit'],$_POST['titre'],$_POST['description'],$_POST['prix'],$_POST['categorie'],$img,$_POST['stock']);
                    ...
                    <div class="card">
                        <div class="row">
                            <div class="col-10 ml-lg-4 ">
                                <form class="forms-sample" action="ModProd.php" method="post" enctype="multipart/form-data">
                                    <div class="form-group">

                                        <label for="exampleInputName1">ID produit</label>
                                        <input type="text" required value="<?PHP echo $produit['id_produit']; ?>"
                                               name="id_produit" class="form-control" id="exampleInputName1"
                                               placeholder="Name">
                                        <input type="text" id="id_produit" name="id_produit" hidden
                                               value="<?PHP echo $produit['id_produit']; ?>" class="form-control"
                                               id="exampleInputName1" placeholder="Name">
                                    </div>

                                    <div class="form-group">
                                        <label for="exampleTextarea1">titre</label>
                                        <textarea name="titre" id="titre" required class="form-control"
                                                  id="exampleTextarea1"
                                                  rows="4"><?PHP echo $produit['titre']; ?></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="prix" name="prix" required
                                               value="<?PHP echo $produit['prix']; ?>" class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="stock" name="stock" required
                                               value="<?PHP echo $produit['stock']; ?>" class="form-control"
                                               id="exampleInputEmail3" placeholder="Email">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="img" type="file" id="img" class="file-upload-default">
                                                            ...
                                                            <div class="form-check form-check-primary">
                                                                <label class="form-check-label">
                                                                    <input name="categorie" type="radio"
                                                                           value="<?PHP echo $row['nom_categorie']; ?>"
