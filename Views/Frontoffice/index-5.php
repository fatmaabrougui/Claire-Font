...
<!-- Mirrored from demo.hasthemes.com/koparion-preview/koparion/index-5.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 20 Nov 2019 17:47:57 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="home-5">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-12">
                        <div class="logo-area">
                            <a href="index.php"><img src="img/logo/4.png" alt="logo" /></a>
                        </div>
                    </div>
    ...
    <div class="slider-area">
        <div class="slider-active owl-carousel">
            <div class="single-slider pt-135 pb-180 bg-img" style="background-image:url(img/slider/10.jpg);">
                <div class="container">
            ...
            <div class="single-slider pt-135 pb-180 bg-img" style="background-image:url(img/slider/9.jpg);">
                <div class="container">
                    <div class="slider-content-3 slider-animated-1">
                        <h1>Do it <br>Yourself</h1>
                        <p class="slider-sale">
    ...
    <div class="bestseller-area pt-100 pb-100">
        <div class="container">
            <div class="row">
                    ...
                    <div class="deal-active owl-carousel">
                        <div class="single-deal">
                            <div class="deal-off-day">
                                ...
                                <div class="timer">
                                    <div data-countdown="2020/11/15"></div>
                                </div>
                            </div>
                        ...
                        <div class="single-deal">
                            <div class="deal-off-day">
                                ...
                                <p>Long printed dress with thin adjustable straps. V-neckline and wiring under the bust with ruffles at the bottom of the dress.</p>
                                <div class="timer">
                                    <div data-countdown="2020/09/15"></div>
                                </div>
                            </div>
                            <div class="banner-img-3">
    ...
    <!-- product-area-end -->
    <!-- banner-area-start -->
    <div class="banner-area-5 pt-95 pb-25">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
    ...
    <div class="most-product-area pt-95 pb-100">
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-4 col-12">
                    ...
                    <div class="col-lg-12">
                        <div class="single-testimonial text-center">
                            ...
                            <div class="testimonial-text">
                                ...
                                <a href="#"><span>Sandy Wilcke </span>/user</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12">
            ...
            <div class="row">
                ...
                <div class="post-active owl-carousel text-center">
                    ...
                    <div class="col-lg-12">
                        <div class="single-post">
                            <div class="post-img">
                                <a href="blog-details.php"><img src="img/post/2.jpg" alt="post" /></a>
                                <div class="blog-date-time">
                                    <span class="day-time">06</span>
                                    <span class="moth-time">Dec</span>
                                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="single-post">
                            <div class="post-img">
                                <a href="blog-details.php"><img src="img/post/3.jpg" alt="post" /></a>
                                <div class="blog-date-time">
                    ...
                    <div class="col-lg-12">
                        <div class="single-post">
                            <div class="post-img">
                                <a href="blog-details.php"><img src="img/post/4.jpg" alt="post" /></a>
                                <div class="blog-date-time">
...
<!-- Mirrored from demo.hasthemes.com/koparion-preview/koparion/index-5.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 20 Nov 2019 17:48:00 GMT -->
</html>