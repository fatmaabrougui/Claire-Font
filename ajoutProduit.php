...
if (!empty($_FILES['img'])) {
    ...
    $produit=new Produit($_POST['id_produit'],$_POST['titre'], $_POST['auteur'],$img,$_POST['prix'],$_POST['qt'],$_POST['categorie']);
                                    ...
                                    <div class="col-10 ml-lg-4 ">
                                        <form class="forms-sample" method="post" onsubmit="return testAjouProduit()"  enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" required name="auteur" class="form-control" id="auteur" placeholder="auteur">
                                            </div>

                                            <div class="form-group">
                                                <label for="exampleInputPassword4">Prix</label>
                                                <input type="number" required name="prix" class="prix" id="prix" placeholder="prix">
                                            </div>
