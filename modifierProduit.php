                ...
                <nav class="navbar-sidebar2">
                    <ul class="list-unstyled navbar__list">
                        <li class="active has-sub">
                          ...
                          <i class="fas fa-tachometer-alt"></i>Categorie</a>
                      <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                          <li>
                              <a href="ajoutCategorie.php">ajouter Categorie</a>
                          </li>
                          <li>
                              <a href="afficherCategorie.php">afficher categorie</a>
                          </li>
                                ...
                                <div class="row">
                                    <div class="col-10 ml-lg-4 ">
                                        <form class="forms-sample" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label for="exampleTextarea1">auteur</label>
                                                <textarea name="auteur" required class="form-control"
                                                          id="exampleTextarea1"
                                                          rows="4"><?PHP echo $produit['auteur']; ?></textarea>
                                                          <div class="form-group">
                                                              <label for="exampleTextarea1">titre</label>
                                                              <textarea name="titre" required class="form-control"
                                                                        id="exampleTextarea1"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input required type="number" name="quantite"
                                                       value="<?PHP echo $produit['qt']; ?>" class="form-control"
